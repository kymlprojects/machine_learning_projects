 function [my_break,neff5,neff4,neff3,neff2,neff1,node_prob,tree,eff,earn_time, beginning,win_percentage, endd, guess, earning,not_lose_percentage,durr] =  last_data_project(indice, big_linearray, big_wave_array)
...
for i=1:length(knn_array)
    if knn_array(i,3)>0
searchmagnitude(i,1) = knn_array(i,3)*1/100;
searchmagnitude(i,2) = knn_array(i,3)*180/5;
    elseif knn_array(i,3)<0
searchmagnitude(i,2) = knn_array(i,3)*1/100;
searchmagnitude(i,1) = knn_array(i,3)*180/5;  
    end
end
