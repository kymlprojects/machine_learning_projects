...
%     price_withTrend = [price_withTrend; x];
    ...
    for i = 1:length(big_wave_array)
     ...
     for i = 1:length(big_wave_array)
        big_linearray(i,6) = price_withTrend(big_linearray(i,2));
     end
    
    for i = 1:length(big_wave_array)
        big_linearray(i,7) = price_withTrend(big_linearray(i,1));
    end
 ...
 x=[big_linearray(:,1) big_linearray(:,2)];
 y=[big_linearray(:,7) big_linearray(:,6)];
 plot(x',y')